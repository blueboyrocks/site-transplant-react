...
import { ShoppingCart, Database, Shield, Zap, CheckCircle, ArrowRight } from 'lucide-react';

const DataCoffeeRetail = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background/50 to-primary/5">
      <section className="pt-32 pb-16 px-4">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
            ...
            <span>/</span>
            <span>Data Coffee</span>
          </nav>
          
          <div className="text-center">
            <h1 className="text-5xl font-bold mb-6 bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent">
              Unify Retail Data from All Sources
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Eliminate manual data wrangling and create unified customer profiles from POS systems, e-commerce platforms, loyalty programs, and social media.
            </p>
      ...
      <section className="py-16 px-4">
        ...
        >
          <h2 className="text-3xl font-bold mb-4">Ready to Unify Your Retail Data?</h2>
          <div className="flex gap-4 justify-center">
            <Button asChild size="lg">
              <Link to="/contact?product=data-coffee&industry=retail">
...
export default DataCoffeeRetail;